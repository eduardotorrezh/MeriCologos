...
Route::namespace('App\Http\Controllers\Api')->group(function (){
    ...
    Route::namespace('App\Http\Controllers\Api')->group(function (){
        Route::post('/login','PassportController@login')->name('login');
        Route::post('/register','PassportController@store')->name('register');
    
        Route::get('/branchOffices','BranchOfficeController@index')->name('branch_offices.index')->middleware(['auth:api','role_or_permission:global_admin|branch_offices.index']);
        ...
        Route::post('/branchOffices','BranchOfficeController@store')->name('branch_offices.store')->middleware(['auth:api','role_or_permission:global_admin|branch_offices.store']);
        Route::get('/branchOffices/{branchOffice}','BranchOfficeController@show')->name('branch_offices.index')->middleware(['auth:api','role_or_permission:global_admin|branch_offices.index']);
        Route::put('/branchOffices/{branchOffice}','BranchOfficeController@update')->name('branch_offices.update')->middleware(['auth:api','role_or_permission:global_admin|branch_offices.update']);
        Route::delete('/branchOffices/{branchOffice}','BranchOfficeController@destroy')->name('branch_offices.destroy')->middleware(['auth:api','role_or_permission:global_admin|branch_offices.destroy']);
    
        Route::post('/authUserInfo','PassportController@authUserInfo')->name('authUserInfo')->middleware('auth:api');
        Route::post('/test','PassportController@test')->name('test')->middleware(['auth:api','role_or_permission:global_admin|testpermissions']);
    });
